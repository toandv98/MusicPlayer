...
object API {
    const val CLIENT_ID = "c4f14f84ca83495796910797d8568199"
    const val CLIENT_SECRET = "84603a39a90a4aef9a2d965c7d1cb926"
    const val REDIRECT_URI = "com.toandv.demo.musicplayer://callback"
}
